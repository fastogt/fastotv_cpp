...
class FavoriteInfo : public common::serializer::JsonSerializer<FavoriteInfo> {
 public:
  ...
  bool Equals(const FavoriteInfo& eq) const;
...
inline bool operator==(const FavoriteInfo& lhs, const FavoriteInfo& rhs) {
  return lhs.Equals(rhs);
}

inline bool operator!=(const FavoriteInfo& x, const FavoriteInfo& y) {
  return !(x == y);
}
